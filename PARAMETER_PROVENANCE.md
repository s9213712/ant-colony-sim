...
|---|---|---|---|---:|---|
| `diffusionRate` | 費洛蒙擴散倍率 | UI percent | 模型假設 | D | 對應半衰期/擴散係數 |
| `evaporationRate` | 費洛蒙蒸發倍率 | UI percent | 模型假設 | D | 對應 trail decay data |
| `senseThreshold` | 最小可感知費洛蒙總量 | grid value | 模型假設 | D | 對應行為反應閾值 |
