...
## 10. Paper-condition validation matrix v1
...
python3 experiments/paper_conditions_probe.py \
  --seeds 1-3 \
  --output outputs/paper_conditions_v1.csv \
  --json-output outputs/paper_conditions_v1.json \
  --report-output outputs/paper_conditions_report_v1.md
```
