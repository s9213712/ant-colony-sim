...
- Traffic detours are generated by a shared crowded-traffic rule. High local pressure creates crowded-step opportunities; frontal crowding creates encounter opportunities; redirects alter heading through the same rule for all experiments.
